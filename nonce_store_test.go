...
func TestDefaultNonceStore(t *testing.T) {
	...
	_, ns := DbConnection("your connection string here")
...
func accept(t *testing.T, ns *MysqlNonceStore, op, nonce string) {
...
func reject(t *testing.T, ns *MysqlNonceStore, op, nonce string) {
	e := ns.Accept(op, nonce)
	if e == nil {
